...
This repository provides a complete, modular implementation of the LC-3b computer architecture—from source-level assembly to a fully pipelined CPU core. Each module represents a self-contained component of the architecture and can be used independently or as part of a larger toolchain.
